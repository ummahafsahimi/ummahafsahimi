...
My background blends **DevOps, Cloud, CI/CD, Linux, Python automation, ML for Image Processing, and advanced SAR/InSAR analytics** — a mix that lets me solve problems from both a systems and data perspective.
...
## 🛠️ Tech Stack  
**Cloud & Infra:** AWS · Linode · Terraform · Ansible · Kubernetes · Docker  
